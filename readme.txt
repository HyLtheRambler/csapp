...
The shlab has the entire 16 trace files for you to check the correctness of your implementation of the tiny shell. You'll have to do it manually though as there is no autograder.
